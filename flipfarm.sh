...
alias "flipfarm-client-worker"="flipfarm;celery -A clientAgent worker -c 1 -n `uname -n` --statedb=clientState --beat"
alias "flipfarm-server-worker"="flipfarm;celery -A serverAgent worker -c 4 -n `uname -n` --statedb=serverState --beat"
