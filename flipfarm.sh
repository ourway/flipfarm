...
alias "flipfarm-client-worker"="flipfarm;celery -A clientAgent worker -c 1 --statedb=clientState --beat"
alias "flipfarm-server-worker"="flipfarm;celery -A serverAgent worker -c 4 --statedb=serverState --beat"
